...
export class TicketsController {
  ...
  restore(@Param('id') id: string, @Request() req) {
    ...
    return this.ticketsService.restore(+id, req.user.sub);
  }
  ...
  importTickets(
    ...
    return this.ticketsService.importTickets(+projectId, file.buffer, req.user.sub);
  }
  ...
  addDependency(
    ...
    return this.ticketsService.addDependency(+ticketId, blockerId, req.user.sub);
  }
  ...
  removeDependency(
    ...
    return this.ticketsService.removeDependency(+ticketId, +blockerId, req.user.sub);
  }
